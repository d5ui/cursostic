...
/**
 * Elementor compatibility - Allow full control
 * NOTA: Este theme funciona MEJOR con Elementor
 * Edita la página de inicio con Elementor para control visual completo
 */
