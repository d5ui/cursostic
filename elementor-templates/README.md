...
## 📥 PASO 1: Importar el Template de Inicio

### A) Descargar el archivo
1. Ve a la carpeta del theme: `/elementor-templates/`
2. Descarga el archivo: **`home-template.json`**

### B) Importar en Elementor
1. En WordPress, ve a **Plantillas → Guardadas**
2. Haz clic en **"Importar Plantillas"** (arriba)
3. Selecciona el archivo **`home-template.json`**
4. Haz clic en **"Importar ahora"**
5. ¡Listo! Template importado

### C) Aplicar a tu página de inicio
1. Ve a **Páginas → Inicio** (o créala si no existe)
2. Haz clic en **"Editar con Elementor"**
3. Haz clic en el icono de **carpeta** 📁 (arriba a la izquierda)
4. Selecciona **"Plantillas guardadas"**
5. Busca **"CursosTIC - Página de Inicio"**
6. Haz clic en **"Insertar"**
7. Haz clic en **"Publicar"**

**¡Y YA ESTÁ!** Tu página de inicio está lista.

---

## 🎨 QUÉ INCLUYE EL TEMPLATE DE INICIO

### Sección 1: Hero Banner
- ✅ Fondo gradiente azul profesional
- ✅ Título grande "Formación TIC de Calidad"
...
- ✅ Título de sección
- ✅ Widget automático que muestra 6 cursos destacados
- ✅ Tarjetas con diseño profesional
- ✅ Se actualiza automáticamente cuando añades cursos
...
## ⚙️ PERSONALIZAR EL TEMPLATE (Opcional)

Una vez insertado, puedes editar:

### Cambiar textos:
1. Haz clic en cualquier texto
2. Edita en el panel izquierdo
3. Guarda

### Cambiar colores:
1. Haz clic en la sección
2. Ve a **Estilo → Fondo**
3. Cambia los colores del gradiente
4. Usa: `#2563eb` y `#1e40af` (colores del theme)

### Cambiar número de cursos:
1. Haz clic en el widget "Grid de Cursos"
2. En el panel izquierdo: **Número de Cursos**
3. Cambia de 6 a lo que quieras

### Añadir más secciones:
1. Haz clic en el **+** entre secciones
2. Añade widgets de Elementor o del theme

---

## 🔧 ALTERNATIVA: Crear desde Cero con el Widget

Si prefieres diseñar tú mismo:

1. Crea página nueva
2. Edita con Elementor
3. Busca la categoría **"CursosTIC"** en el panel izquierdo
4. Arrastra el widget **"Grid de Cursos"**
...
3. En **"Página de inicio"**: Selecciona tu página "Inicio"
4. Guarda cambios
...
### "No veo el widget 'Grid de Cursos'"
**Solución:**
1. Verifica que el child theme esté **ACTIVO**
2. Ve a **Elementor → Herramientas → Regenerar archivos CSS**
3. Guarda y recarga

### "El template se ve raro al importar"
**Solución:**
1. Asegúrate de usar **Elementor Canvas** o **Elementor Full Width** como template de página
2. Ve a **Configuración de Página → Diseño → Elementor Canvas**

### "No aparecen los cursos"
**Solución:**
1. Ve a **Cursos** y publica al menos 1 curso
2. Marca algunos como **"Destacados"** en la edición del curso
3. El widget solo muestra cursos publicados y destacados

### "Sigue viéndose el contenido mezclado"
**Solución:**
1. En la página, haz clic en **"Editar con Elementor"**
2. Elimina TODO el contenido antiguo
3. Vuelve a importar el template limpio
4. Limpia caché del navegador (Ctrl+Shift+R)

---

## 📊 WIDGETS INCLUIDOS EN EL TEMPLATE

### cursostic_curso_grid
- Muestra grid de cursos con tarjetas
- Configuración:
  - `posts_per_page`: 6
  - `show_featured_only`: yes
  - `orderby`: date
  - `order`: DESC
...
Para mantener coherencia visual, usa estos colores:
...
## 💡 VENTAJAS DE USAR EL TEMPLATE

✅ **NO necesitas diseñar nada**
✅ **Instalación en 2 minutos**
✅ **100% responsive**
✅ **Diseño profesional probado**
✅ **Fácil de personalizar**
✅ **Compatible con todos los widgets de Elementor**
✅ **Se actualiza automáticamente con tus cursos**
...
Si tienes problemas:
1. Verifica que el child theme está activo
2. Asegúrate de tener Elementor instalado
3. Limpia la caché del navegador
4. Regenera CSS de Elementor

**¿Necesitas ayuda?** Dime qué ves exactamente y te ayudo.
